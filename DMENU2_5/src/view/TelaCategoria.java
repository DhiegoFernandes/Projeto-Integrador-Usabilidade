...
//pega (Obtem) a lista de pizzas atraves da mesa
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Ativar/Desativar por id");
   ...
   try {
            ...
            if (txtAtivarDesativar.getText().length() < 1) {
                ...
                catDAO.buscaPorID(id, cat);
                cat.setStatus("ativado");//######ATIVA A categoria#####
                catDAO.atualizaMesa(cat);//chama o metodo de atualizacao
    ...
    private void btnDesativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesativarActionPerformed
        try {
            ...
            if (txtAtivarDesativar.getText().length() < 1) {
                ...
                Categoria cat = new Categoria();
                catDAO.buscaPorID(id, cat);
                cat.setStatus("desativado");//######desativa A categoria#####
                catDAO.atualizaMesa(cat);//chama o metodo de atualizacao

                //Mensagem de retorno ao usuario
                JOptionPane.showMessageDialog(null, "Categoria desativada com sucesso!");
            }

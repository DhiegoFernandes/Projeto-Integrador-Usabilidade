    ...
    public List<Produto> listaTodosOsProdutos() throws SQLException {//obtem todos os produtos
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                prod.setFk_produto_categoria(resultado.getInt("fk_produto_categoria")); // Define categoria do produto;
    ...
    public void insereProduto(Produto prod) {
        ...
        try {
            ...
            sql += "INSERT INTO produto"
                    + "(idproduto, nome, preco, descricao, fk_produto_categoria, status)" //6 VALORES
                    + "VALUES"
                    + "(?, ?, ?, ?, ?, ?)"; //6 INTERROGAÇOES
            ...
            st.setInt(5, prod.getFk_produto_categoria());
    ...
    public Produto buscaPorID(int idproduto, Produto prod) {
        ...
        try {
            ...
            if (rs.next()) { //testa se veio algum resultado
                ...
                prod.setFk_produto_categoria(rs.getInt("fk_produto_categoria"));
     ...
     public void atualizaProduto(Produto prod) throws SQLException {
        ...
        try {
            ...
            sql += "UPDATE produto " //ATUALIZA produto ONDE idproduto FOR X
                    + "SET nome = ?, preco = ?, descricao = ?, fk_produto_categoria = ?, status = ?"
                    + "WHERE idproduto = ?";
            ...
            st.setInt(4, prod.getFk_produto_categoria());
